		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'type'          => 'text',
					'default_value' => __( 'Free shipping on all orders over $100', 'ecommerce-mobile-theme' ),
				),
				array(
				...
				array(
					...
					'name'          => 'hero_heading',
					'type'          => 'text',
					'default_value' => __( 'Find clothes that match your style', 'ecommerce-mobile-theme' ),
				),
				array(
					...
					'type'          => 'textarea',
					'rows'          => 3,
					'default_value' => __( 'Browse premium essentials and statement pieces curated for a modern wardrobe.', 'ecommerce-mobile-theme' ),
				),
				array(
					...
					'type'          => 'text',
					'default_value' => __( 'Shop now', 'ecommerce-mobile-theme' ),
				),
				array(
				...
				array(
					...
					'name'          => 'section_title',
					'type'          => 'text',
					'default_value' => __( 'New Arrivals', 'ecommerce-mobile-theme' ),
				),
				array(
